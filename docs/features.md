...
| performance-measurements | Per-scenario AST and generated measurements after output parity verification | implemented | passed | not-deployed | [Performance measurements](operations/benchmark.md) |
