...
The policy applies to supported runtimes as well as tools. A test dependency cannot require a runtime newer than the package claims to support. CI tests the PHP packages and extension at the declared PHP 8.2 minimum and at the current release environment.
