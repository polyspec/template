...
| 문서 | 주제 |
| --- | --- |
| [`spec/lexical.md`](/ko/spec/lexical) | 소스 인코딩, 태그 시작 규칙, 이스케이프, 주석, 태그 종료, standalone 줄 제거 |
| [`spec/grammar.md`](/ko/spec/grammar) | 태그 문법, 블록 구조, 닫기 규칙 |
| [`spec/expressions.md`](/ko/spec/expressions) | 표현식 토큰, 문법, 우선순위, 평가 |
