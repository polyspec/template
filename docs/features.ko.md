...
| generated-mode | 정규 AST를 내장한 호스트 언어 소스 모듈과 일치성 검사(TypeScript·JavaScript·Go·Rust·PHP) | implemented | passed | not-deployed | [실행 모드](spec/runtime.ko.md#지원-레벨과-컴파일-artifact) |
