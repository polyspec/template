...
function render_content_tpl(Assign $assign, array $slots, Input_content_tpl $input): string { $out = '';
...
function render_template(string $target, Assign $assign, array $slots): string { return match ($target) {
        "content.tpl" => render_content_tpl($assign, $slots, new Input_content_tpl()),
